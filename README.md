...
31 | [**Folder-Automater**](https://github.com/decipher07/Useful-Python-scripts-collection/blob/master/Folder-Automater/automateall.py) | A Python script that compiles all the different formats of files present in the respective folder to a new folder containing only the Specified files. | None | 
