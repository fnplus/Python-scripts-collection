...
31 | [**DirectorySummarizer**](https://github.com/j0fiN/Python-scripts-collection/tree/master/DirectorySummarizer) | A Python script which summarizes the number of different files in a directory. It also gives out the percentage of a particular file extension you want to know. | None | 
