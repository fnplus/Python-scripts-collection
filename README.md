...
32 | [**Currency Conveter**](https://github.com/sharmas1ddharth/Useful-Python-scripts-collection/blob/master/CurrencyConverter/currencyConverter.py) | A Python script which can convert currency by scraping live rates from the floatrates website. | requests | 
